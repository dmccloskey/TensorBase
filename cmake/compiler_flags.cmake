...
if (CMAKE_COMPILER_IS_GNUCXX)
  ...
  if (NOT MT_ENABLE_CUDA)  # necessary since CUDA contains non-pedantic code
	...
	if (NOT TENSORBASE_64BIT_ARCHITECTURE AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER "4.3.0" AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.4.0")
...
elseif (MSVC)
	...
	# use set(CF_TENSORBASE_ADDCXX_FLAGS "${CF_TENSORBASE_ADDCXX_FLAGS} ...") instead

	## disable dll-interface warning
	set(CF_TENSORBASE_ADDCXX_FLAGS "${CF_TENSORBASE_ADDCXX_FLAGS} /wd4251 /wd4275")

	## disable deprecated functions warning (e.g. for POSIX functions)
	set(CF_TENSORBASE_ADDCXX_FLAGS "${CF_TENSORBASE_ADDCXX_FLAGS} /wd4996")

	## disable explicit template instantiation request for partially defined classes
	set(CF_TENSORBASE_ADDCXX_FLAGS "${CF_TENSORBASE_ADDCXX_FLAGS} /wd4661")

	## disable warning: "decorated name length exceeded, name was truncated"
	set(CF_TENSORBASE_ADDCXX_FLAGS "${CF_TENSORBASE_ADDCXX_FLAGS} /wd4503")

  ## disable warning: "unknown pragma" (occurs thousands of times for, e.g. '#pragma clang diagnostic ignored "-Wfloat-equal"')
	set(CF_TENSORBASE_ADDCXX_FLAGS "${CF_TENSORBASE_ADDCXX_FLAGS} /wd4068")
	...
	add_definitions(/DTENSORBASE_XERCESDLL)
  ...
  if (NOT TENSORBASE_64BIT_ARCHITECTURE)
