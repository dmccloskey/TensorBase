...
namespace cereal
{
  ...
  struct specialize<Archive, TensorBase::TensorDataGpu<TensorT, TDim>, cereal::specialization::member_serialize> {};
  template <class Archive, typename TensorT, int TDim>
  struct specialize<Archive, TensorBase::TensorDataGpuPrimitiveT<TensorT, TDim>, cereal::specialization::member_serialize> {};
  template <class Archive, template<class> class ArrayT, class TensorT, int TDim>
  struct specialize<Archive, TensorBase::TensorDataGpuClassT<ArrayT, TensorT, TDim>, cereal::specialization::member_serialize> {};
}
