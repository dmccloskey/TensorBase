...
namespace TensorBase
{
  ...
  public:
    ...
    */
    ...
    virtual void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray32<char>, DeviceT, 2>>& values_old, DeviceT& device) = 0;
    virtual void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray128<char>, DeviceT, 2>>& values_old, DeviceT& device) = 0;
    virtual void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray512<char>, DeviceT, 2>>& values_old, DeviceT& device) = 0;
    virtual void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray2048<char>, DeviceT, 2>>& values_old, DeviceT& device) = 0;
#if COMPILE_WITH_CUDA
    ...
    virtual void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArrayGpu8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArrayGpu32<char>, DeviceT, 2>>& values_old, DeviceT& device) = 0;
    virtual void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArrayGpu8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArrayGpu128<char>, DeviceT, 2>>& values_old, DeviceT& device) = 0;
    virtual void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArrayGpu8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArrayGpu512<char>, DeviceT, 2>>& values_old, DeviceT& device) = 0;
    virtual void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArrayGpu8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArrayGpu2048<char>, DeviceT, 2>>& values_old, DeviceT& device) = 0;
#endif
  ...
  public:
    ...
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
    void selectIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 1>>& select_labels, DeviceT& device) {
      tensor_table_->selectIndicesView(axis_name, dimension_index, select_labels, device);
    };
#endif
    ...
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
    void sortIndicesView(const std::string& axis_name, const int& dimension_index, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 1>>& select_labels, const sortOrder::order& order_by, DeviceT& device) {
      tensor_table_->sortIndicesView(axis_name, dimension_index, select_labels, order_by, device);
    };
#endif
    ...
    void updateTensorDataValues(const std::shared_ptr<TensorArray32<char>[]>& values_new, std::shared_ptr<TensorArray32<char>[]>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, values_old, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArray128<char>[]>& values_new, std::shared_ptr<TensorArray128<char>[]>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, values_old, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArray512<char>[]>& values_new, std::shared_ptr<TensorArray512<char>[]>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, values_old, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArray2048<char>[]>& values_new, std::shared_ptr<TensorArray2048<char>[]>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, values_old, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void updateTensorDataValues(const std::shared_ptr<TensorArrayGpu32<char>[]>& values_new, std::shared_ptr<TensorArrayGpu32<char>[]>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, values_old, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArrayGpu128<char>[]>& values_new, std::shared_ptr<TensorArrayGpu128<char>[]>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, values_old, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArrayGpu512<char>[]>& values_new, std::shared_ptr<TensorArrayGpu512<char>[]>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, values_old, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArrayGpu2048<char>[]>& values_new, std::shared_ptr<TensorArrayGpu2048<char>[]>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, values_old, device);
    };
#endif
    ...
    void updateTensorDataValues(const std::shared_ptr<TensorArray32<char>[]>& values_new, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArray128<char>[]>& values_new, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArray512<char>[]>& values_new, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArray2048<char>[]>& values_new, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void updateTensorDataValues(const std::shared_ptr<TensorArrayGpu32<char>[]>& values_new, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArrayGpu128<char>[]>& values_new, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArrayGpu512<char>[]>& values_new, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, device);
    };
    void updateTensorDataValues(const std::shared_ptr<TensorArrayGpu2048<char>[]>& values_new, DeviceT& device) {
      tensor_table_->updateTensorDataValuesConcept(values_new, device);
    };
#endif
    ...
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    ...
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    ...
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
    void appendToAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->appendToAxisConcept(axis_name, labels, values, indices, device);
    };
#endif
    ...
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    ...
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    ...
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
    void deleteFromAxis(const std::string& axis_name, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, DeviceT& device) {
      tensor_table_->deleteFromAxisConcept(axis_name, indices, labels, values, device);
    };
#endif
    ...
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    ...
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray32<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray128<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray512<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArray2048<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArray2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<int[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<float[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<double[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<char[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    ...
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu32<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu32<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu128<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu128<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu512<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu512<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<int, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<float, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<double, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<char, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
    void insertIntoAxis(const std::string & axis_name, const std::shared_ptr<TensorData<TensorArrayGpu2048<char>, DeviceT, 2>>& labels, std::shared_ptr<TensorArrayGpu2048<char>[]>& values, const std::shared_ptr<TensorData<int, DeviceT, 1>>& indices, DeviceT & device) {
      tensor_table_->insertIntoAxisConcept(axis_name, labels, values, indices, device);
    };
#endif
    ...
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray8<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray32<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray128<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray512<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArray8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArray2048<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArrayGpu8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArrayGpu32<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArrayGpu8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArrayGpu128<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArrayGpu8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArrayGpu512<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
    void updateTensorDataConstant(const std::shared_ptr<TensorData<TensorArrayGpu8<char>, DeviceT, 1>>& values_new, std::shared_ptr<TensorTable<TensorArrayGpu2048<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataConstantConcept(values_new, values_old, device);
    };
#endif
    ...
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArray8<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArray32<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArray128<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArray512<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArray2048<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
#if COMPILE_WITH_CUDA
    ...
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArrayGpu32<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArrayGpu128<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArrayGpu512<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
    void updateTensorDataFromSparseTensorTable(const std::shared_ptr<TensorTable<TensorArrayGpu2048<char>, DeviceT, 2>>& values_old, DeviceT& device) {
      tensor_table_->updateTensorDataFromSparseTensorTableConcept(values_old, device);
    };
#endif
