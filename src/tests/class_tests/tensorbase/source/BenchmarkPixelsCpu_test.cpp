...
BOOST_AUTO_TEST_CASE(InsertUpdateDelete0DShardingCpu)
{
  // Parameters for the test
  std::string data_dir = "";
  const int n_dims = 0;
...
BOOST_AUTO_TEST_CASE(InsertUpdateDelete1DShardingCpu)
{
  // Parameters for the test
  std::string data_dir = "";
  const int n_dims = 1;
...
BOOST_AUTO_TEST_CASE(InsertUpdateDelete2DShardingCpu)
{
  // Parameters for the test
  std::string data_dir = "";
  const int n_dims = 2;
...
BOOST_AUTO_TEST_CASE(InsertUpdateDelete3DShardingCpu)
{
  // Parameters for the test
  std::string data_dir = "";
  const int n_dims = 3;
...
BOOST_AUTO_TEST_CASE(InsertUpdateDelete4DShardingCpu)
{
  // Parameters for the test
  std::string data_dir = "";
  const int n_dims = 4;
