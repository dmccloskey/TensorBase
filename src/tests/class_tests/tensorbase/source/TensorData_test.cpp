...
{
	TensorDataCpu<float, 0>* ptr = nullptr;
	TensorDataCpu<float, 0>* nullPointer = nullptr;
	ptr = new TensorDataCpu<float, 0>();
...
{
	TensorDataCpu<float, 0> tensordata, tensordata_test;
...
{
	TensorDataGpu<float, 3, int, int, int> tensordata(2, 3, 4);
...
{
	TensorDataCpu<float, 3, int, int, int> tensordata(2, 3, 4);
