...
BOOST_AUTO_TEST_CASE(gettersAndSetters)
{
  ...
  BOOST_CHECK_EQUAL(tensorCollection.tensor_tables_.at("1")->getIndices().at("1")->operator()(0), 1);
  BOOST_CHECK_EQUAL(tensorCollection.tensor_tables_.at("1")->getIndicesView().at("1")->operator()(0), 1);
}
