...
BOOST_AUTO_TEST_CASE(InsertUpdateDeleteDefaultDevice)
{
  ...
  SelectAndCountNodePropertyDefaultDevice<TensorArray8<char>, TensorArray8<char>> selectAndCountNodeProperty;
  ...
  SelectAndCountLinkPropertyDefaultDevice<TensorArray8<char>, TensorArray8<char>> selectAndCountLinkProperty;
  ...
  SelectAdjacencyDefaultDevice<int, float> selectAdjacency;
  ...
  // Query for the BFS
  SelectBFSDefaultDevice<int, float> selectBFS;
  ...
  // Query for the SSSP
  SelectSSSPDefaultDevice<int, float> selectSSSP;
