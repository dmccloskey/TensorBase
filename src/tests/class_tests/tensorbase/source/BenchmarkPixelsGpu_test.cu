...
void test_InsertUpdateDelete0DGpu()
{
  ...
  std::shared_ptr<TensorCollection<Eigen::GpuDevice>> n_dim_tensor_collection = tensor_collection_generator.makeTensorCollection(n_dims, data_size, shard_span_perc, true);
  ...
  benchmark_1_tp.insert1TimePoint, in_memory(n_dims, transaction_manager, data_size, device);
  ...
  for (int i = 0; i < 5; ++i) {
    ...
    assert(n_dim_tensor_collection->tables_.at("TTable")->getIsModified().at("xyztv")->getData()(i) == 0);
  ...
  benchmark_1_tp.update1TimePoint, in_memory(n_dims, transaction_manager, data_size, device);
  assert(cudaStreamSynchronize(stream) == cudaSuccess);
  n_dim_tensor_collection->tables_.at("TTable")->syncAxesAndIndicesHData(device);
  n_dim_tensor_collection->tables_.at("TTable")->syncHData(device);
  ...
  benchmark_1_tp.delete1TimePoint, in_memory(n_dims, transaction_manager, data_size, device);
  assert(cudaStreamSynchronize(stream) == cudaSuccess);
  n_dim_tensor_collection->tables_.at("TTable")->syncAxesAndIndicesHData(device);
  n_dim_tensor_collection->tables_.at("TTable")->syncHData(device);
  assert(n_dim_tensor_collection->tables_.at("TTable")->getAxes().at("xyztv")->getNDimensions() == 1);
...
void test_InsertUpdateDelete1DGpu() 
{
  ...
  for (int i = 0; i < 1; ++i) {
    ...
    assert(n_dim_tensor_collection->tables_.at("TTable")->getIsModified().at("values")->getData()(i) == 0);
...
void test_InsertUpdateDelete2DGpu()
{
  ...
  for (int i = 0; i < xyz_dim_size; ++i) {
    ...
    assert(n_dim_tensor_collection->tables_.at("TTable")->getIsModified().at("xyz")->getData()(i) == 0);
...
void test_InsertUpdateDelete3DGpu()
{
  ...
  for (int i = 0; i < xy_dim_size; ++i) {
    ...
    assert(n_dim_tensor_collection->tables_.at("TTable")->getIsModified().at("xy")->getData()(i) == 0);
  ...
  for (int i = 0; i < z_dim_size; ++i) {
    ...
    assert(n_dim_tensor_collection->tables_.at("TTable")->getIsModified().at("z")->getData()(i) == 0);
...
void test_InsertUpdateDelete4DGpu()
{
  ...
  for (int i = 0; i < x_dim_size; ++i) {
    ...
    assert(n_dim_tensor_collection->tables_.at("TTable")->getIsModified().at("x")->getData()(i) == 0);
  ...
  for (int i = 0; i < y_dim_size; ++i) {
    ...
    assert(n_dim_tensor_collection->tables_.at("TTable")->getIsModified().at("y")->getData()(i) == 0);
